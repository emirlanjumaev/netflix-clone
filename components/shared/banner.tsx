  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 h-[95vh] w-full -z-10">
        ...
        <div
          className={
            "absolute w-full h-full bg-gradient-to-r dark:from-slate-800 from-white  to-transparent bottom-0 z-20"
          }
        />
      </div>
      ...
      <h1
        className={
          "text-2xl md:text-4xl lg:text-7xl font-bold line-clamp-1 text-red-500"
        }
      >
